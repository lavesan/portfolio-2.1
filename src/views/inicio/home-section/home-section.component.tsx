    ...
    <StyledHomeSection>
      ...
      <div style={{ height: 20 }}>
        <Typing
          ...
          speed={typingSpeed}
          cursorClassName="introduction-section--info--cursor"
        >
          <span className="introduction-section--info--typed-tag">
            {paragraphStart.map((word, index) => (
              <BounceWordAnimation key={index} activateOnClick={true}>
                {word}
              </BounceWordAnimation>
            ))}
          </span>
      ...
      <div style={{ height: 40 }}>
        {typingAnimation[1] && (
          <Typing
            onFinishedTyping={() => activateTypingAnimation(2)}
            speed={typingSpeed}
            cursorClassName="introduction-section--info--cursor"
          >
            <span className="introduction-section--info--typed-tag">
              {paragraphEnd.map((word, index) => (
                <BounceWordAnimation key={index} activateOnClick={true}>
                  {word}
                </BounceWordAnimation>
              ))}
        ...
        {typingAnimation[2] && (
          <Typing
            onFinishedTyping={() => activateTypingAnimation(3)}
            speed={typingSpeed}
            cursorClassName="introduction-section--info--cursor"
          >
            <span className="introduction-section--info--typed-tag">
              {headingStart.map((word, index) => (
                <BounceWordAnimation key={index} activateOnClick={true}>
                  {word}
                </BounceWordAnimation>
              ))}
      ...
      <div style={{ height: 40 }}>
        {typingAnimation[3] && (
          <Typing
            onFinishedTyping={() => activateTypingAnimation(4)}
            speed={typingSpeed}
            cursorClassName="introduction-section--info--cursor"
          >
            <span className="introduction-section--info--typed-tag">
              {headingEnd.map((word, index) => (
                <BounceWordAnimation key={index} activateOnClick={true}>
                  {word}
                </BounceWordAnimation>
              ))}
        ...
        {typingAnimation[4] && (
          <Typing
            onFinishedTyping={() => activateTypingAnimation(5)}
            speed={typingSpeed}
            cursorClassName="introduction-section--info--cursor"
          >
            <span className="introduction-section--info--typed-tag">
