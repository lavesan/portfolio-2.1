...
const Start = () => {
  ...
  const onRefChange = useCallback((node: any, refName: any) => {
  ...
  return (
    <StyledInicioPage>
      ...
      <section className="white-bg" id="sobre-mim">
        {/* @ts-ignore */}
        <ScrollTrigger
          onEnter={() => onScrollEnter("about")}
          onExit={() => onScrollExit("about")}
        >
          <div className="titles-container">
            <h2
              ref={useCallback((node: any) => onRefChange(node, "about"), [])}
            >
              Sobre mim
            </h2>
            <StyledUnderbarTitle
              width={titlesRef.about ? titlesRef.about.offsetWidth : 0}
            />
          </div>
      ...
      <section className="white-bg project-section" id="projetos">
        {/* @ts-ignore */}
        <ScrollTrigger
          onEnter={() => onScrollEnter("projects")}
          onExit={() => onScrollExit("projects")}
        >
          <div className="titles-container">
            <h2
              ref={useCallback(
                (node: any) => onRefChange(node, "projects"),
                []
              )}
            >
              Projetos
            ...
            <StyledUnderbarTitle
              width={titlesRef.projects ? titlesRef.projects.offsetWidth : 0}
            />
          </div>
      ...
      <section className="white-bg" id="blogs">
        {/* @ts-ignore */}
        <ScrollTrigger
          onEnter={() => onScrollEnter("blogs")}
          onExit={() => onScrollExit("blogs")}
        >
          <div className="titles-container">
            <h2
              ref={useCallback((node: any) => onRefChange(node, "blogs"), [])}
            >
              Blogs
            </h2>
            <StyledUnderbarTitle
              width={titlesRef.blogs ? titlesRef.blogs.offsetWidth : 0}
            />
          </div>
      ...
      <section className="black-bg" id="contato">
        {/* @ts-ignore */}
        <ScrollTrigger
          onEnter={() => onScrollEnter("contact")}
          onExit={() => onScrollExit("contact")}
        >
          <div className="titles-container">
            <h2
              ref={useCallback((node: any) => onRefChange(node, "contact"), [])}
            >
              Contato
            </h2>
            <StyledUnderbarTitle
              width={titlesRef.contact ? titlesRef.contact.offsetWidth : 0}
            />
          </div>
